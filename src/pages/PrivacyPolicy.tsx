...
export default function PrivacyPolicyArtistic() {
  return (
      ...
      <main style={styles.shell}>
        ...
        >
          <div style={styles.eyebrowRow}>
            ...
            <span style={styles.eyebrow}>ROMANIAN MICROMOSAIC · PRIVACY</span>
          </div>
          ...
          <p style={styles.lead}>Our privacy practices presented in a clean, readable artistic layout.</p>
        </motion.div>
        ...
        >
          ...
          <h2 style={styles.cardTitle}>Data we collect</h2>
          <p style={styles.cardText}>We collect minimal data necessary to respond to inquiries and process orders.</p>
        </motion.section>
