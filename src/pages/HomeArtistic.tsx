...
<header style={styles.pageHeader}>
  <div style={styles.headerInner}>
    <div style={styles.headerEmblem} aria-hidden="true">
    ...
    <div style={styles.headerBrandBlock}>
      ...
      <h1 style={styles.headerBrand}>Romana</h1>
    ...
    <p style={styles.headerHint}>Scroll to enter the atelier</p>
  </div>
</header>
        ...
        <section style={styles.hero} className="home-artistic-hero">
          <div style={styles.heroContent}>
            ...
            >
              ...
              <span style={styles.eyebrow}>Roman style mosaic · heritage atelier</span>
            </motion.div>
...
Handcrafted by master artisans.
          ...
          >
            <div style={styles.heroFrame}>
              ...
              <div style={styles.heroImageMain}>
                ...
                <div style={styles.heroCaption}>
                  ...
                  <strong style={styles.heroCaptionTitle}>A fragment of eternity</strong>
                </div>
              </div>

              <div style={styles.floatingMosaic}>
        ...
        {/* ORNAMENTAL DIVIDER */}
        <div style={styles.ornamentalDivider} aria-hidden="true">
        ...
        <section style={styles.featureSection}>
          <div style={styles.sectionHeadingRow}>
            <div>
              ...
              <h2 style={styles.sectionHeading}>Made to be looked at twice.</h2>
            </div>
            <p style={styles.sectionAside}>
        ...
        <section style={styles.storySection}>
          <div style={styles.storyImageWrap}>
            <img src={romanWoman} alt="Romanian figure and heritage" style={styles.storyImage} />
            <div style={styles.storyImageBorder} />
            <div style={styles.storyImageTag}>HERITAGE / 01</div>
          </div>
          ...
          <div style={styles.galleryGrid} className="home-artistic-gallery-grid">
            {galleryTiles.map((tile, index) => (
              ...
              >
                ...
                <div style={styles.galleryTileMeta}>
        ...
        <section style={styles.ctaSection}>
          ...
          <div style={styles.ctaSeal} aria-hidden="true">
